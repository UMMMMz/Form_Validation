...
var emaiError = document.getElementById("email-error");
...
function validateEmail(){
    ...
    if(!email.match(/^[A-Za-z\._\-[0-9]*[@][A-Za-z]*[\.][a-z]{2,4}$/)){
        emaiError.innerHTML = 'Email Invalid';
        return false ;

    }
    emaiError.innerHTML = '<i class="fa-regular fa-circle-check"></i>';
    return true ;
...
function validateMsg(){
    ...
    if(left>0){
        msgError.innerHTML = left +  ' More Charachters Required ';
        return false ;
